    ...
    <div class="container">
        ...
        <div class="well">
        {{ Form::model($role, ['route' => ['roles.update', $role->name], 'method' => 'PATCH', 'class' => 'form-horizontal']) }}
        ...
        {{ Form::close() }}
        {{ Form::open(['route' => ['roles.destroy', $role->name], 'method' => 'DELETE', 'class' => 'form-horizontal']) }}
            <div class="form-group">
